...
<template>
  <div class="options-page">
    ...
    <v-container fluid>
      <v-layout row wrap justify-center test3>

        <container>
<div class="col-md-12 pla">
 <!-- General -->
          <h3 class="title mt-3 mb-3 mla">{{ $t('options.general_title') }}</h3>
          ...
          <!-- Security -->
          <h3 class="title mt-4 mb-4 mla">{{ $t('options.security_title') }}</h3>
          <v-layout row wrap align-center>
            <v-flex xs12>
              <v-checkbox
          ...
          <!-- Chats -->
          <h3 class="title mt-4 mb-4 mla">{{ $t('options.chats_title') }}</h3>
          <v-layout row wrap align-center>
            <v-flex xs12>
              <v-checkbox
          ...
          <!-- Notifications -->
          <h3 class="title mt-4 mb-4 mla">{{ $t('options.notification_title') }}</h3>
          <v-layout row wrap align-center>
            <v-flex xs12>
              <v-checkbox
          ...
          <!-- Delegates -->
          <h3 class="title mt-4 mb-4 mla">{{ $t('options.other') }}</h3>
          <v-layout row wrap align-center>
           <v-flex xs12>
             ...
             <div class="text-xs-left">{{ $t('options.version') }} {{ this.$root.$options.version }}</div>
           </v-flex>
          </v-layout>
