...
describe('Store: chat.js', () => {
  ...
  describe('getters', () => {
    ...
    describe('getters.lastMessageText', () => {
      it('should return last message text', () => {
        ...
        // type `message` or `tys transaction`
    ...
    describe('getters.isChatReadOnly', () => {
      it('should return boolean', () => {
        ...
        expect(isChatReadOnly('tyslinBounty')).toBe(true)
        expect(isChatReadOnly('tyslinTokens')).toBe(false)
  ...
  describe('mutations', () => {
    ...
    /**
     * mutations.createTyslinChats
     */
    describe('mutations.createTyslinChats', () => {
      it('should push `Tyslin Bounty` to state.chats', () => {
        const state = {
          chats: {}
        }

        mutations.createTyslinChats(state)

        expect(state.chats['Tyslin Bounty']).toBeTruthy()
      })
    })
  ...
  describe('actions', () => {
    ...
    describe('actions.createChat', () => {
      ...
      it('should resolve and create chat without `partnerName`', async () => {
        // mock & replace `tysApi.getPublicKey` dependency
        chatModule.__Rewire__('tysApi', {
