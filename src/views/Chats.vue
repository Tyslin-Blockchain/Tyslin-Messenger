...
.v-dialog{width: 31% !important;
overflow: hidden;}

.theme--dark.v-divider{border:none}
</style>
...
<template>
  <v-layout row wrap justify-center>
    <container>
      ...
      <v-layout row wrap>
        <v-flex xs12>
<input type="text" placeholder="Search" class="search3">
      ...
      <!-------------
<div class="col-md-12" style="background-color:#000">buy coins</div>---------->
...
export default {
  computed: {
     ...
     *
     * Important: `timestamp` is Tyslin Timestamp.
     *
