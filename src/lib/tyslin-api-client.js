...
/**
 * Encapsulates an TYSLIN node. Provides methods to send API-requests
...
/**
 * Provides methods for calling the TYSLIN API.
 *
 * The `ApiClient` instance automatically selects an TYSLIN node to
...
const endpoints = config.server.tys.map(endpoint => endpoint.url)
