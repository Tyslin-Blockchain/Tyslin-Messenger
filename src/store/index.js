...
import tysModule from './modules/tys'
...
const store = {
  ...
  getters: {
    ...
    publicKey: state => tyslinAddress => state.publicKeys[tyslinAddress]
  },
  mutations: {
    ...
    setPublicKey (state, { tyslinAddress, publicKey }) {
      state.publicKeys[tyslinAddress] = publicKey
    }
  },
  actions: {
  ...
  modules: {
    ...
    nodes: nodesModule, // Tyslin nodes
    snackbar,
    language,
    chat,
    options,
